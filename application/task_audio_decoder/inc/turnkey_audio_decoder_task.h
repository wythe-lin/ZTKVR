...
#define MP3_RING_BUF_SIZE 	  1024*32
#define MP3_DECODE_HW_RAM     7176    

#define RING_BUF_SIZE 	      MP3_RING_BUF_SIZE
...
extern INT32S  audio_play_file_set(INT16S fd, AUDIO_CONTEXT *aud_context, AUDIO_CTRL *aud_ctrl);
