...
#define AUDIO_INPUT_SRC					MIC_INPUT_SRC
	...
	#define C_ADC_USE_CHANNEL			ADC_LINE_0				//adc channel: 0 ~ 3 , //wwj modify from ADC_LINE_1 to ADC_LINE_0
...
#define AUD_CUT_OFF_FREQ	            16384	//Cut_Off_Freq = CutOff_Frequency*65536, Q16 (ex: 0.25 * 65536 = 16384)
#define AUD_FILTER_ORDER		        3		//Filter_Order = 1~10
