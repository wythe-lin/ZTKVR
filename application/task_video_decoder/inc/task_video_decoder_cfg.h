...
#define MPEG4_DECODE_ENABLE			0	//0: disable, 1:enable
#define S263_DECODE_ENABLE			0	//fix 0: disable, not support yet
#define ALL_VIDEO_IN_ONE_ENABLE		0	//0: disable, 1:enable	

#define MP3_DECODE_ENABLE			0	//0: disable, 1:enable
...
#else
	#define PARSER_VID_BITSTREAM_SIZE	125000 //byte
#endif
...
typedef enum
{
	...
	MSG_VIDEO_DECODE_SET_PLAY_TIME,
