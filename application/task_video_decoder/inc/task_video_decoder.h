...
extern INT32S mjpeg_decode_get_size(INT32U raw_data_addr, INT32U size, INT16U *width, INT16U *height);
extern INT32S mjpeg_memory_alloc(INT32S fifo_flag, INT32S jpeg_yuv_mode, INT16U jpeg_w, INT16U jpeg_h);
extern void mjpeg_memory_free(void);
extern void mjpeg_decode_set_scaler(INT32U scaler_fifo, INT32U scaler_mode, INT32U output_addr, INT32S jpeg_yuv_mode,
...
extern INT32S mjpeg_decode_and_scaler(INT32U sacler_flag, INT32U raw_data_addr, INT32U size, INT32U ecode_output_addr, 
								INT16U image_output_w, INT16U image_output_h, INT16U output_buffer_w, INT16U output_buffer_h);
extern INT32S mjpeg_decode_without_scaler(INT32U raw_data_addr, INT32U size, INT32U ecode_output_addr);
...
//scaler
extern INT32S scaler_size_start(INT32U scaler_flag,
