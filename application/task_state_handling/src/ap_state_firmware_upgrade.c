...
void ap_state_firmware_upgrade(void)
{
	...
	buff_size = gvarg.DisplayBufferWidth * gvarg.DisplayBufferHeight * 2;
	...
	ascii_str.buff_w     = gvarg.DisplayBufferWidth;
	ascii_str.buff_h     = gvarg.DisplayBufferHeight;
	...
	DBG_PRINT("\033[0;32;31m" "[m]: system hold ...\r\n" "\033[m");
