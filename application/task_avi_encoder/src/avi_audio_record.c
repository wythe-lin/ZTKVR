...
//				if (avi_adc_dma_status_get() != 1)
		...
		case AVI_AUDIO_RECORD_START:
...
#endif
			_dmsg((GREEN "AVI_AUDIO_RECORD_START - 2\r\n" NONE));
			bStop = audio_flag = 0;
...
#if MIC_INPUT_SRC == C_ADC_LINE_IN || MIC_INPUT_SRC == C_BUILDIN_MIC_IN
			_dmsg((GREEN "AVI_AUDIO_RECORD_START - 3\r\n" NONE));
			mask = 0x8000;
			...
			_dmsg((GREEN "AVI_AUDIO_RECORD_START - 4\r\n" NONE));
...
#endif
			DBG_PRINT(PURPLE "AudEncStartFail!!!\r\n" NONE);
