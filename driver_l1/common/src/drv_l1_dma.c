...
INT32S dma_sprite_buffer_copy(INT32U s_addr, INT32U t_addr, INT32U byte_count, INT32U s_width, INT32U t_width)
{
	return dma_buffer_copy_extend(s_addr, t_addr, byte_count, s_width, t_width, C_DMA_MISC_FB_TO_SPRITE, C_DMA_CTRL_SINGLE_ACCESS);	
}
#endif
