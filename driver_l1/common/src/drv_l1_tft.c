...
/**********************************************
 ILI9341_LX240A3602B driver
**********************************************/
#define LCD_CS  IO_B2
#define LCD_WR  IO_B3
#define LCD_RST IO_B5
#define LCD_RS  IO_B1
#define LCD_BL  IO_B6

#define TM024HBH_RS 1
#define TM024HBH_CS 2
#define TM024HBH_WR 3

#define WriteCom_TM02(Pin,data)  R_IOB_O_DATA=(R_IOB_O_DATA&(~(1<<Pin)))|(data<<Pin)
#define WriteData_TM02(data)  R_IOA_O_DATA=data&0x00FF
/*写命令*/
void Wirte_Com_TM024HBH(INT8U Data)
{
 WriteCom_TM02(TM024HBH_RS,0);    //RS 置于低
 WriteCom_TM02(TM024HBH_CS,0);    //CS 置于低

 WriteData_TM02(Data&0x00ff);
 WriteCom_TM02(TM024HBH_WR,0);    //WR 置于低
 WriteCom_TM02(TM024HBH_WR,1);    //WR 置于高

 WriteCom_TM02(TM024HBH_RS,1);    //RS 置于高
 WriteCom_TM02(TM024HBH_CS,1);    //CS 置于高
}

/*写数据*/
void Wirte_Data_TM024HBH(INT8U Data)
{
 WriteCom_TM02(TM024HBH_RS,1);    //CS 置于高
 WriteCom_TM02(TM024HBH_CS,0);    //CS 置于低
...
// VCI=2.8V
//************* Reset LCD Driver **************** //
	DBG_PRINT("ILI9341_LX240A3602B_Initial \r\n");
		...
		//gpio_set_port_attribute(LCD_RD, ATTRIBUTE_HIGH);//modify, connect to VCC
		gpio_set_port_attribute(LCD_RST, ATTRIBUTE_HIGH);
		gpio_set_port_attribute(LCD_BL, ATTRIBUTE_HIGH);
		...
		gpio_init_io(LCD_RST, GPIO_OUTPUT);
		gpio_init_io(LCD_BL, GPIO_OUTPUT);

		gpio_write_io (LCD_CS, DATA_HIGH);
		...
		gpio_write_io (LCD_BL, DATA_LOW);
		//gpio_write_io (LCD_BL, DATA_HIGH);
...
gpio_set_port_attribute(LCD_RST, ATTRIBUTE_HIGH);
gpio_init_io(LCD_RST,GPIO_OUTPUT);
gpio_drving_init_io(LCD_RST, IO_DRIVING_16mA);
/*
gpio_set_port_attribute(LCD_BL, ATTRIBUTE_HIGH);
gpio_init_io(LCD_BL, GPIO_OUTPUT);
gpio_write_io (LCD_BL, DATA_LOW);
*/
//==============================================================
 gpio_write_io (LCD_RST, DATA_HIGH);//复位
 drv_msec_wait (5);
...
Wirte_Com_TM024HBH(0xCF);
Wirte_Data_TM024HBH (0x00);
Wirte_Data_TM024HBH (0xC8);
Wirte_Data_TM024HBH (0X30);

Wirte_Com_TM024HBH(0xed);
Wirte_Data_TM024HBH (0x64);
Wirte_Data_TM024HBH (0x03);
Wirte_Data_TM024HBH (0x12);
Wirte_Data_TM024HBH (0x81);

Wirte_Com_TM024HBH(0xe8);
Wirte_Data_TM024HBH (0x85);
Wirte_Data_TM024HBH (0x10);
Wirte_Data_TM024HBH (0x79);

Wirte_Com_TM024HBH(0xcb);
Wirte_Data_TM024HBH (0x39);
Wirte_Data_TM024HBH (0x2c);
Wirte_Data_TM024HBH (0x00);
Wirte_Data_TM024HBH (0x34);
Wirte_Data_TM024HBH (0x02);

Wirte_Com_TM024HBH(0xea);
Wirte_Data_TM024HBH (0x00);
Wirte_Data_TM024HBH (0x00);

Wirte_Com_TM024HBH(0xC0);
Wirte_Data_TM024HBH (0x21);

Wirte_Com_TM024HBH(0xC1);
Wirte_Data_TM024HBH (0x11);

Wirte_Com_TM024HBH(0xC5);
Wirte_Data_TM024HBH (0x40);
Wirte_Data_TM024HBH (0x37);

Wirte_Com_TM024HBH(0xc7);
Wirte_Data_TM024HBH (0xa0);

Wirte_Com_TM024HBH(0x3A);
Wirte_Data_TM024HBH (0x55);

//Wirte_Com_TM024HBH(0x36);
//Wirte_Data_TM024HBH (0x08);

Wirte_Com_TM024HBH(0xB1);
Wirte_Data_TM024HBH (0x00);
Wirte_Data_TM024HBH (0x18);

Wirte_Com_TM024HBH(0xB6);
Wirte_Data_TM024HBH (0x0a);
Wirte_Data_TM024HBH (0xa2);

Wirte_Com_TM024HBH(0xF2);
Wirte_Data_TM024HBH (0x00);

Wirte_Com_TM024HBH(0xF7);
Wirte_Data_TM024HBH (0x20);

Wirte_Com_TM024HBH(0x26);
Wirte_Data_TM024HBH (0x01);

Wirte_Com_TM024HBH(0xE0);
Wirte_Data_TM024HBH (0x0f);
Wirte_Data_TM024HBH (0x1d);
Wirte_Data_TM024HBH (0x1d);
Wirte_Data_TM024HBH (0x0a);
Wirte_Data_TM024HBH (0x0e);
Wirte_Data_TM024HBH (0x09);
Wirte_Data_TM024HBH (0x4f);
Wirte_Data_TM024HBH (0x85);
Wirte_Data_TM024HBH (0x41);
Wirte_Data_TM024HBH (0x09);
Wirte_Data_TM024HBH (0x16);
Wirte_Data_TM024HBH (0x08);
Wirte_Data_TM024HBH (0x15);
Wirte_Data_TM024HBH (0x0d);
Wirte_Data_TM024HBH (0x00);

Wirte_Com_TM024HBH(0xE1);
Wirte_Data_TM024HBH (0x00);
Wirte_Data_TM024HBH (0x1c);
Wirte_Data_TM024HBH (0x1f);
Wirte_Data_TM024HBH (0x02);
Wirte_Data_TM024HBH (0x0f);
Wirte_Data_TM024HBH (0x05);
Wirte_Data_TM024HBH (0x34);
Wirte_Data_TM024HBH (0x14);
Wirte_Data_TM024HBH (0x46);
Wirte_Data_TM024HBH (0x02);
Wirte_Data_TM024HBH (0x0b);
Wirte_Data_TM024HBH (0x09);
Wirte_Data_TM024HBH (0x32);
Wirte_Data_TM024HBH (0x36);
Wirte_Data_TM024HBH (0x0f);

Wirte_Com_TM024HBH(0x11);
drv_msec_wait(120);
Wirte_Com_TM024HBH(0x29);



	Wirte_Com_TM024HBH(0x36); //Set Gamma
	//Wirte_Data_TM024HBH(0xa8); 		//0x68 //0xa8   // 屏幕旋转 my,mx,mv,ml,BGR,mh,0.0
	Wirte_Data_TM024HBH(0x68); 		//0x68 //0xa8   // 屏幕旋转 my,mx,mv,ml,BGR,mh,0.0

	Wirte_Com_TM024HBH(0x3a);         //Memory data  access control
	Wirte_Data_TM024HBH(0x05);         //MY MX MV ML RGB MH 0 0
	//==========================================================
	Wirte_Com_TM024HBH(0x2a);          // column set
	Wirte_Data_TM024HBH(0x00);          //if MADCTL BIT5=0, EC[15:0]=0x00ef
	Wirte_Data_TM024HBH(0x00);          //if MADCTL BIT5=1, EC[15:0]=0x013f
	Wirte_Data_TM024HBH(0x01); 	//00
	Wirte_Data_TM024HBH(0x3f); 	//ef

	Wirte_Com_TM024HBH(0x2b);        	// page address set
	Wirte_Data_TM024HBH(0x00);          //if MADCTL BIT5=0, EP[15:0]=0x013f
	Wirte_Data_TM024HBH(0x00);          //if MADCTL BIT5=1, EP[15:0]=0x00ef
	Wirte_Data_TM024HBH(0x00); 	//01
	Wirte_Data_TM024HBH(0xef); 	//3f

	drv_msec_wait(50);
	Wirte_Com_TM024HBH(0x29); //Display on



	Wirte_Com_TM024HBH(0x2C);
//   LCD_Clear_QS1201(RED);
 drv_msec_wait(10);

	//==================================================================

	//Write_LCD_data_LX24002V((INT32U)background_b);
	//while(1)


	/*配置系统数据*/
  	R_TFT_VS_WIDTH = 20;  //0xD0500148
    R_TFT_V_PERIOD = 319; //0xD0500144
	R_TFT_V_START = 5;	  //0xD050014C

	R_TFT_HS_WIDTH = 3;	  //0xD0500158
	R_TFT_H_PERIOD = 239; //0xD0500154
	R_TFT_H_START = 1;	  //0xD050015C

	R_TFT_VS_START = 0;	  //0xD05001B0
	R_TFT_VS_END = 320;   //0xD05001B4
	R_TFT_HS_START = 0;   //0xD05001B8
	R_TFT_HS_END = 240;	  //0xD05001BC

/*
  //tft_data_mode_set(TFT_DATA_MODE_8);
	R_TFT_TS_MISC=(1<<14);					//0xD05003C8
	R_TFT_CTRL=0x20c7|(0<<1);				//0xD0500140
//	R_TFT_LINE_RGB_ORDER=(1<<7);
//设置时钟
	R_TFT_TS_MISC|=(0<<6);
	R_TFT_CTRL|=(0<<1);
	*/
//	R_TFT_TS_MISC= 0x0000; //marty mark
//	R_TFT_CTRL = 0x20C1;//0x20C7
//	R_TFT_CTRL = 0x20D2; marty mark
...
#if 1
INT32S tft_backlight_en_set(BOOLEAN en)
{
	if(en){
...
void Write_COMMAND16i(INT8U cmd)
{
        ...
        for (i=0;i<8;i++) {
                // shift data
                gpio_write_io(SDA_n, ((cmd&0x80)>>7)); /* SDA */
                cmd = (cmd<<1);
                cmd_delay(10);
                // toggle clock
                gpio_write_io(SCL_n,1);//SCL=0
...
void Write_DATA16i(INT8U Data)
{
        ...
        for (i=0;i<8;i++) {
                //shift data
                gpio_write_io(SDA_n, ((Data&0x80)>>7)); /* SDA */
                Data = (Data<<1);
                cmd_delay(10);
                // toggle clock
                gpio_write_io(SCL_n,1);//SCL=0
...
void tft_ALT020ESLN_init(void)
{
 ...
 cmd_delay(80);
    ...
    Write_COMMAND16i(0xcb);       //power control
 Write_DATA16i(0x01);          //VRH[5:0]

    Write_COMMAND16i(0xB9);
 Write_DATA16i(0xFF);
 Write_DATA16i(0x93);
 Write_DATA16i(0x42);
 ...
 Write_COMMAND16i(0xC7);
 Write_DATA16i(0xc6);

 Write_COMMAND16i(0xB8);
 Write_DATA16i(0x09);
 ...
 cmd_delay(180);
 Write_COMMAND16i(0x2c); //Display ON
 cmd_delay(180);


    R_TFT_HS_WIDTH                        = 10;                                //        1                =HPW                                0xD0500158
    R_TFT_H_START                         = 10+19;                        //        20                =HPW+HBP                                        0xD050015C
    R_TFT_H_END                           = 10+19+960;        //        1300        =HPW+HBP+HDE                                        0xD0500160
    R_TFT_H_PERIOD                        = 10+19+960+40;        //        1340        =HPW+HBP+HDE+HFP                        0xD0500154
    R_TFT_VS_WIDTH                        = 20;                                //        1                =VPW                                (DCLK)        0xD0500148
    R_TFT_V_START                         = 2;                        //        21                =VPW+VBP                        (LINE)                0xD050014C
    R_TFT_V_END                           = 20+1+240;                //        261                =VPW+VBP+VDE                (LINE)                0xD0500150
    R_TFT_V_PERIOD                        = 20+1+240+1;                //        262                =VPW+VBP+VDE+VFP        (LINE)                0xD0500144
    R_TFT_LINE_RGB_ORDER    = 0x00;                                                                                                          //0xD0500164

    R_TFT_CTRL            = 0x8319;
    R_TFT_TS_MISC=0;

    tft_signal_inv_set(TFT_HSYNC_INV|TFT_VSYNC_INV, (TFT_ENABLE & TFT_HSYNC_INV)|(TFT_VSYNC_INV&TFT_ENABLE));
    tft_mode_set(TFT_MODE_UPS051);
    tft_data_mode_set(TFT_DATA_MODE_8);
    tft_clk_set(TFT_CLK_DIVIDE_8);
    R_TFT_CTRL|=(1<<13);      //Byte
