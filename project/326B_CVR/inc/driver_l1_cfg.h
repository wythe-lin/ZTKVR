...
//===========================================================================================//
    ...
    #define C_DISPLAY_DEVICE            ILI9341//TPO_TD025THD1//TPO_TD025THD1//C_TV_VGA          		// Select one of the display device from above list
    ...
    #define LCD_BACKLIGHT_MODE          LCD_BACKLIGHT_LED
    ...
    #define __GPIO_PAD_DEFINE__
         ...
         #define SPI1_POS                    SPI1_RX_IOI3__CLK_IOI1__TX_IOI2//SPI1_RX_NONE__CLK_NONE__TX_NONE
